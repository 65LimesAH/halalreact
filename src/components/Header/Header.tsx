...
const HalalHeader = () => (
    <Grid container stackable style={{ background: `url(${background})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", }}>
        ...
        <Grid.Row columns={3} textAlign='center' >
            <Grid.Column >
                <Header as='h4' style={{ fontSize: '1.25em' }} block color="orange">
                    Where to find us!
                    <Header.Subheader>3642 N. Beltline Rd, Irving TX 75062</Header.Subheader>
                </Header>
            </Grid.Column>
            <Grid.Column>
                <Header as='h4' style={{ fontSize: '1.25em' }} block color="orange">
